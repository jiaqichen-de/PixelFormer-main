...
# This head is the implementation of log binomial distribution
...
class ConditionalLogBinomial(nn.Module):
    def __init__(self, in_features, condition_dim, n_classes=256, bottleneck_factor=2, p_eps=1e-4, max_temp=50, min_temp=1e-7, act=torch.softmax):
        ...
        """we use the final features obtained from the nested sub-network as the primary feature, 
        the features obtained from SAM1 as the secondary feature, 
        and generate parameters p and t within an cnn"""
